package com.isigntech.edgeservice.filter;
		...
		try {
			...
			if (email != null && SecurityContextHolder.getContext().getAuthentication() == null) {
				...
				if (jwtService.validateToken(jwt, email)) {
					...
					// Collection<? extends GrantedAuthority> convertToGrantedAuthorities =
					// jwtService.convertToGrantedAuthorities(authorities);
